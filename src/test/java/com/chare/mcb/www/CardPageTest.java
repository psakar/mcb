...
public class CardPageTest extends WicketTestCase {
	...
	private void startPage() {
		page = tester.startPage(CardPage.class);
	}
	...
	public void testContainsChildren() throws Exception {
		startPage();
		assertComponentIs(CardPanel.class, UserPage.PANEL_ID);
	}
	...
	static class TestConfig {
		...
		public CardRepository cardRepository() {
			CardRepository userRepository = mock(CardRepository.class);
			when(userRepository.findById(1)).thenReturn(new Card());
